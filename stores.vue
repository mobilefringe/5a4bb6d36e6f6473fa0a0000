<template>
    <div class="page-container"> <!-- for some reason if you do not put an outer container div this component template will not render -->
        <mapplic-map :store_source="getStoreSource" :height="800" :minimap= "true" :sidebar="true" :maxscale= "5" @mapready="mapready" @locationopened="locationopened" @locationclosed="locationclosed" @levelswitched="levelswitched" @positionchanged="positionchanged"></mapplic-map>
    </div>
</template>
<script>
